...
import AuditedFinancialsRow from '../audited-financials-row';
import AuditedFinancialsIncomeTaxRow from '../audited-financials-income-tax-return-row';
...
export default function AuditedFinancialsIncomeTaxReturnListView({ companyProfile }) {
