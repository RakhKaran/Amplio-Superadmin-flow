...
export default function TransactionTableRow({ row, selected, onEditRow, onViewRow, onSelectRow, onDeleteRow }) {
  const { tType, from, to, amount, date, reference } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{tType}</TableCell>
